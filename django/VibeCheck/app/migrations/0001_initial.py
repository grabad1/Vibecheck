# Generated by Django 4.2.25 on 2025-10-09 10:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iduserrecieve', models.ForeignKey(db_column='iduserrecieve', on_delete=django.db.models.deletion.DO_NOTHING, related_name='friend_requests_received', to='app.user')),
                ('idusersend', models.ForeignKey(db_column='idusersend', on_delete=django.db.models.deletion.DO_NOTHING, related_name='friend_requests_sent', to='app.user')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='created',
            name='idplaylist',
            field=models.ForeignKey(db_column='idplaylist', on_delete=django.db.models.deletion.DO_NOTHING, to='app.playlist'),
        ),
        migrations.AddField(
            model_name='created',
            name='iduser',
            field=models.ForeignKey(db_column='iduser', on_delete=django.db.models.deletion.DO_NOTHING, to='app.user'),
        ),
        migrations.CreateModel(
            name='Contains',
            fields=[
        ...
        migrations.AddField(
            model_name='collab',
            name='idplaylist',
            field=models.ForeignKey(blank=True, db_column='idplaylist', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.playlist'),
        ),
        migrations.AddField(
            model_name='collab',
            name='iduser',
