...
CREATE TABLE `rated` (
  ...
  KEY `r.iduser_idx` (`iduser`),
  CONSTRAINT `r.createdfk` FOREIGN KEY (`idmoderator`, `idplaylist`) REFERENCES `created` (`iduser`, `idplaylist`),
  CONSTRAINT `r.iduser` FOREIGN KEY (`iduser`) REFERENCES `user` (`idUser`)
